...
class gsp_SLR_headMeta_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/_headMeta.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
invokeTag('captureMeta','sitemesh',1,['gsp_sm_xmlClosingForEmptyTag':(""),'name':("author"),'content':("argonzalez")],-1)
}
...
public static final long LAST_MODIFIED = 1487328496000L
